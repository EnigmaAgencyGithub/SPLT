(function () {
	...
	var isProduction = window.location.href.includes(
		'southernpineslandandtimber'
	);

	var contactUsUrl = '';
	if (isLocalhost) {
		contactUsUrl = 'https://localhost:44346/api/SPLT';
	} else if (isDevelopment) {
		contactUsUrl =
			'https://emailer20210811113143.azurewebsites.net/api/contactus';
	} else if (isProduction) {
		contactUsUrl = 'https://enimgaagencyapi.azurewebsites.net/api/SPLT';
	}
